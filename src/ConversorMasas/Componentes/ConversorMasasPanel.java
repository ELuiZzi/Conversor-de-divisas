package ConversorMasas.Componentes;
...
public class ConversorMasasPanel extends JPanel {
	...
	private void addComponents() {
		...
		cerrarBoton.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(ConversorMasasPanel.this);
				frame.dispose();
			}
	...
	private void cargarListas() {
		...
		for (String lista : ListaEquivalencias.getListaMasasTexto()) {
	...
	private void convertir() {
		...
		try {
			...
			double conversion = ListaEquivalencias.convertirMasas(from, to, amount);
